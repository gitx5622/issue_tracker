    ...
    return ( 
        <div>
          <Row>
            ...
            <CardHeader>Advanced Repository Github issues<Link to="/create/advanced_repo_issue"><Button style={{float:"right"}} theme="success">New Issue</Button><Tag style={{float:"right", marginTop:"7px"}} color="#f50">{repoIssues.length} open</Tag></Link></CardHeader>
            <CardBody>
